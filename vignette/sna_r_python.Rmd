---
title: "Connecting R and Python for Social Network Science Projects"
author: |
...
## Social Network Science Projects
...
Now that I have an environment called `snc`, I could now start using R and Python together. We would need to install the `reticulate` package.
```{r, message=FALSE}
#install.packages("reticulate")
library(reticulate)

use_condaenv(condaenv = "snc", conda = "auto", required = TRUE)
main <- import_main()
